...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/css/style_main.css">
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
<script>
	window.onload = function() {
		let img_files = [ "../images/img1.jpg", "../images/img2.jpg",
				"../images/img102.jpg", ];
		...
		<div id="img_div" class="intro_bg">
			<div class="header">
				...
				<div class="searchArea">
					<form action="">
						<input type="text" id="input_search" name="input_search" value=""
							placeholder="Search"> <span>검색</span>
					</form>
				</div>
				<ul class="nav">
					<li><a href="">HOME</a></li>
					...
					<!-- 로그아웃 -->
					<li><a href="#">${memberVO.memId }로그아웃</a>
						<ul>
							<li>info</li>
		...
		<div class="main_text1">
			...
			<div class="service">
				...
				<div class="contents3">
					...
					<p>안녕하세요 NextIT 입니다. 만나서 반갑습니다. 안녕하세요 NextIT 입니다. 만나서 반갑습니다.
						안녕하세요 NextIT 입니다. 만나서 반갑습니다. </p>
				</div>
			</div>
		</div>
		<!--4차 작업 main_text1 e -->
