...
<jsp:useBean id="searchVO" class="kr.or.nextit.member.vo.MemberSearchVO"></jsp:useBean>
	                    ...
	                    <tbody>
	                        ...
	                        <c:forEach items="${memberList }" var="member">
					 			<tr>
					 				...
					 				<td>${member.rnum }</td>
									<td>
										<a href="${pageContext.request.contextPath }/member/memberRole.jsp?memId=${member.memId}">
										 ${member.memId }
										</a>
...
<form name="memMultiDelete" 
	action="${pageContext.request.contextPath}/member/memberMultiDelete.jsp"
	method="post">
