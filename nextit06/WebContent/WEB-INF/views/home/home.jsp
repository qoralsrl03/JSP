    ...
    <div id="img_div" class="intro_bg">
        <div class="header">
            ...
            <ul class="nav">
                ...
                <li><a href="${pageContext.request.contextPath }/free/freeList.do">FREEBOARD</a></li>
	               	<!--로그아웃  -->
	             	<li><a href="#">${memberVO.memId}</a>
	             		<ul>
	             			<li><a href="${pageContext.request.contextPath }/member/memberView.do?memId=${memberVO.memId}">info</a></li>
	             			<li><a href="#" onclick="fn_logout()">logout</a></li>
	             			 
	             			 <c:forEach items="${memberVO.userRoleList}" var="role">
	             			 		<c:if test="${role.userRole eq 'AD' }">
	             			 			<li><a href="${pageContext.request.contextPath}/member/memberList.do">members</a></li>
	             			 		</c:if>
	             			 </c:forEach>
