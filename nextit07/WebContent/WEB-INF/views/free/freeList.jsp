...
function fn_boardViewBoNo(boNo){
	...
	location.href="${pageContext.request.contextPath}/free/freeView.do?boNo="+boNo+"&searchType="+st+"&searchWord="+sw+"&searchCategory="+sc+"&curPage="+cp+"&rowSizePerPage="+rpp;
}
</script>
</head>
<body>
			...
			<c:if test="${bnf eq null and de eq null}">
	            ...
	            <div class="div_paging">
	                ...
	                <div class="div_board_write">
	                    <input type="button" onclick="location.href='${pageContext.request.contextPath}/free/freeForm.do'" value="글쓰기">
	                </div>
	            </div>
            </c:if>
