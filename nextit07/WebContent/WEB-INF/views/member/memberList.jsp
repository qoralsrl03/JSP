        ...
        <div class="content01">
			...
			<c:if test="${bnf eq null and de eq null}">
            	<div class="div_search">
					<form name="search" action="${pageContext.request.contextPath}/member/memberList.do" method="post">
	                    ...
	                    <tbody>
	                        ...
	                        <c:forEach items="${memberList }" var="member">
					 			<tr>
					 				...
					 				<td>${member.rnum }</td>
									<td>
										<a href="${pageContext.request.contextPath }/member/memberRole.do?memId=${member.memId}">
										 ${member.memId }
										</a>
...
<form name="memMultiDelete" 
	action="${pageContext.request.contextPath}/member/memberMultiDelete.do"
	method="post">
